export default {
  dashboard: {
    ...
    usageAnalytics: {
      ...
      metricEstimatedCost: 'Estimated Cost',
      metricTotalTokens: 'Total Tokens',
      metricInputTokens: 'Input Tokens',
      metricOutputTokens: 'Output Tokens',
      metricCachedTokens: 'Cached Tokens',
      cacheReadRate: 'Cache read rate',
      share: 'Share',
      summaryMeta: 'Current period',
      summaryCostMeta: 'Actual cost',
      vsPrevious: 'vs previous period',
      trendPeakBucket: 'Peak bucket',
      trendAverageBucket: 'Avg requests / bucket',
      trendRequestChange: 'Request change',
      trendTokenChange: 'Token change',
      trendCostChange: 'Cost change',
      activeEntities: 'Active entries',
      topCostShare: 'Top cost share',
      topRequestShare: 'Top request share',
      longTailShare: 'Long-tail share',
      longTailMeta: 'Entries below 8% request share'
    },
