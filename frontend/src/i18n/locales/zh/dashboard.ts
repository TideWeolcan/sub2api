export default {
  dashboard: {
    ...
    usageAnalytics: {
      metricRequests: '请求数',
      metricEstimatedCost: '预计费用',
      metricTotalTokens: '总 Token',
      metricInputTokens: '输入 Token',
      metricOutputTokens: '输出 Token',
      metricCachedTokens: '缓存 Token',
      cacheReadRate: '缓存读取率',
      share: '占比',
      summaryMeta: '当前周期',
      summaryCostMeta: '实际扣除',
      vsPrevious: '对比上一周期',
      trendPeakBucket: '峰值时段',
      trendAverageBucket: '每时段平均请求',
      trendRequestChange: '请求变化',
      trendTokenChange: 'Token 变化',
      trendCostChange: '费用变化',
      activeEntities: '活跃条目',
      topCostShare: '最高费用占比',
      topRequestShare: '最高请求占比',
      longTailShare: '长尾占比',
      longTailMeta: '请求占比低于 8% 的条目'
    },
    avgResponse: '平均响应',
    averageTime: '平均时间',
    timeRange: '时间范围',
